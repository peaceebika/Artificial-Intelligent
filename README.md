...
All projects were created using **Google Colab** and demonstrate both **classical AI techniques** and **modern learning algorithms**, ranging from decision trees and neural networks to reinforcement learning and game-playing agents. Feel free to explore the material.
...
### Decision Tree
Implementation of **Decision Tree classifiers**, focusing on:
- Feature splitting
- Tree depth control
...
A **Multi-Layer Perceptron (MLP)** applied to a digits dataset.
...
Comparison of different **optimization algorithms** for training an MLP on the **MNIST dataset**:
- SGD
- Adam
- RMSprop
...
**Category:** Classical AI / Search Algorithms
